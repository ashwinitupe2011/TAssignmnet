...
public class MainActivity extends AppCompatActivity implements MainView, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.articleRecyclerList);
    ...
    public void onGetDataSuccess(String message, List<Article> list) {
        mArticleAdapter = new ArticleAdapter(getApplicationContext(), list);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (mArticleAdapter != null && mArticleAdapter.getItemCount() != 0) {
